...
if(typeof(CKEDITOR) !== 'undefined') {
    ...
    [
            ...
            */
            ...
            /* Object Styles */
			{ name : 'date'	, element : 'p', attributes :  {'class' : 'date' } },

            { name : 'Image Left'	, element : 'img', attributes :  {'class' : 'img-left caption' } },

            { name : 'Image Right'	, element : 'img', attributes :  {'class' : 'img-right caption' } },
			
			{ name : 'PhotoBox Left'	, element : 'div', attributes :  {'class' : 'photo-box-left' } },
			
			{ name : 'PhotoBox Right'	, element : 'div', attributes :  {'class' : 'photo-box' } },
