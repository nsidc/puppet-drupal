 ...
 *   The form state.
 */
function nsidc_corporateclean_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['mtt_settings']['breadcrumb']['breadcrumb_display'] = array(
	...
	'#default_value' => theme_get_setting('breadcrumb_display','nsidc_corporateclean'),
  );
  
  $form['mtt_settings']['breadcrumb']['breadcrumb_separator'] = array(
    '#type' => 'textfield',
    '#title' => t('Breadcrumb separator'),
	'#default_value' => theme_get_setting('breadcrumb_separator','nsidc_corporateclean'),
    '#size'          => 5,
    '#maxlength'     => 10,
  );
  ...
  $form['mtt_settings']['slideshow']['slideshow_display'] = array(
	...
	'#default_value' => theme_get_setting('slideshow_display','nsidc_corporateclean'),
  );
  
  $form['mtt_settings']['slideshow']['slideshow_js'] = array(
    '#type' => 'checkbox',
    '#title' => t('Include slideshow javascript code'),
	'#default_value' => theme_get_setting('slideshow_js','nsidc_corporateclean'),
  );
  ...
  $form['mtt_settings']['slideshow']['slideshow_effect'] = array(
	...
	'#default_value' => theme_get_setting('slideshow_effect','nsidc_corporateclean'),
    '#options' => array(
		'blindX' => t('blindX'),
		'blindY' => t('blindY'),
		'blindZ' => t('blindZ'),
  ...
  $form['mtt_settings']['slideshow']['slideshow_effect_time'] = array(
	...
	'#default_value' => theme_get_setting('slideshow_effect_time','nsidc_corporateclean'),
  );
  
  $form['mtt_settings']['slideshow']['slideshow_randomize'] = array(
    '#type' => 'checkbox',
    '#title' => t('Randomize slideshow order'),
	'#default_value' => theme_get_setting('slideshow_randomize','nsidc_corporateclean'),
  );
  
  $form['mtt_settings']['slideshow']['slideshow_wrap'] = array(
    '#type' => 'checkbox',
    '#title' => t('Prevent slideshow from wrapping'),
	'#default_value' => theme_get_setting('slideshow_wrap','nsidc_corporateclean'),
  );
  
  $form['mtt_settings']['slideshow']['slideshow_pause'] = array(
    '#type' => 'checkbox',
    '#title' => t('Pause slideshow on hover'),
	'#default_value' => theme_get_setting('slideshow_pause','nsidc_corporateclean'),
  );
  ...
  $form['mtt_settings']['support']['responsive']['responsive_meta'] = array(
	...
	'#default_value' => theme_get_setting('responsive_meta','nsidc_corporateclean'),
  );
  ...
  $form['mtt_settings']['support']['responsive']['responsive_respond'] = array(
	...
	'#default_value' => theme_get_setting('responsive_respond','nsidc_corporateclean'),
