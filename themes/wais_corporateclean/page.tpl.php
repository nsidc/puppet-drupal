...
<div id="banner">
    ...
    <?php if (theme_get_setting('slideshow_display','wais_corporateclean')): ?>
    ...
    <div id="slideshow">
        ...
        <div class="slider-item">
            <div class="content container_12">
                ...
                <img class="masked" src="<?php print base_path() . drupal_get_path('theme', 'wais_corporateclean') ;?>/mockup/slide-1.jpg"/>
                </div>
        ...
        <div class="slider-item">
            <div class="content container_12">
                ...
                <img class="masked" src="<?php print base_path() . drupal_get_path('theme', 'wais_corporateclean') ;?>/mockup/slide-2.jpg"/>
                </div>
        ...
        <div class="slider-item">
            <div class="content container_12">
                ...
                <!--slider-item content-->
                <img class="masked" src="<?php print base_path() . drupal_get_path('theme', 'wais_corporateclean') ;?>/mockup/slide-3.jpg"/>
                <!--EOF:slider-item content-->
				</div>
            </div>
        </div>
...
<div id="content">
    ...
    <div id="content-inside" class="container_12 clearfix">
        ...
        <?php } ?>
            ...
            <?php if (theme_get_setting('breadcrumb_display','wais_corporateclean')): print $breadcrumb; endif; ?>
