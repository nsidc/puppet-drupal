 ...
 *   The form state.
 */
function wais_corporateclean_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['mtt_settings']['breadcrumb']['breadcrumb_display'] = array(
	...
	'#default_value' => theme_get_setting('breadcrumb_display','wais_corporateclean'),
  );
  
  $form['mtt_settings']['breadcrumb']['breadcrumb_separator'] = array(
    '#type' => 'textfield',
    '#title' => t('Breadcrumb separator'),
	'#default_value' => theme_get_setting('breadcrumb_separator','wais_corporateclean'),
    '#size'          => 5,
    '#maxlength'     => 10,
  );
  ...
  $form['mtt_settings']['slideshow']['slideshow_display'] = array(
	...
	'#default_value' => theme_get_setting('slideshow_display','wais_corporateclean'),
  );
  
  $form['mtt_settings']['slideshow']['slideshow_js'] = array(
    '#type' => 'checkbox',
    '#title' => t('Include slideshow javascript code'),
	'#default_value' => theme_get_setting('slideshow_js','wais_corporateclean'),
  );
  ...
  $form['mtt_settings']['slideshow']['slideshow_effect'] = array(
	...
	'#default_value' => theme_get_setting('slideshow_effect','wais_corporateclean'),
    '#options' => array(
		'blindX' => t('blindX'),
		'blindY' => t('blindY'),
		'blindZ' => t('blindZ'),
  ...
  $form['mtt_settings']['slideshow']['slideshow_effect_time'] = array(
	...
	'#default_value' => theme_get_setting('slideshow_effect_time','wais_corporateclean'),
  );
  
  $form['mtt_settings']['slideshow']['slideshow_randomize'] = array(
    '#type' => 'checkbox',
    '#title' => t('Randomize slideshow order'),
	'#default_value' => theme_get_setting('slideshow_randomize','wais_corporateclean'),
  );
  
  $form['mtt_settings']['slideshow']['slideshow_wrap'] = array(
    '#type' => 'checkbox',
    '#title' => t('Prevent slideshow from wrapping'),
	'#default_value' => theme_get_setting('slideshow_wrap','wais_corporateclean'),
  );
  
  $form['mtt_settings']['slideshow']['slideshow_pause'] = array(
    '#type' => 'checkbox',
    '#title' => t('Pause slideshow on hover'),
	'#default_value' => theme_get_setting('slideshow_pause','wais_corporateclean'),
  );
  ...
  $form['mtt_settings']['support']['responsive']['responsive_meta'] = array(
	...
	'#default_value' => theme_get_setting('responsive_meta','wais_corporateclean'),
  );
  ...
  $form['mtt_settings']['support']['responsive']['responsive_respond'] = array(
	...
	'#default_value' => theme_get_setting('responsive_respond','wais_corporateclean'),
